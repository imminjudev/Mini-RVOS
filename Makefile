...
BENCHMARK_BUILD = build-benchmark-$(BENCHMARK_POLICY)-q$(BENCHMARK_QUANTUM_TICKS)-s$(BENCHMARK_SWITCHES)
...
benchmark:
>$(MAKE) BUILD=$(BENCHMARK_BUILD) BENCHMARK_MODE=1 BENCHMARK_QUANTUM_TICKS=$(BENCHMARK_QUANTUM_TICKS) BENCHMARK_SWITCHES=$(BENCHMARK_SWITCHES) BENCHMARK_USE_ASID=$(BENCHMARK_USE_ASID) all

run-benchmark:
>$(MAKE) BUILD=$(BENCHMARK_BUILD) BENCHMARK_MODE=1 BENCHMARK_QUANTUM_TICKS=$(BENCHMARK_QUANTUM_TICKS) BENCHMARK_SWITCHES=$(BENCHMARK_SWITCHES) BENCHMARK_USE_ASID=$(BENCHMARK_USE_ASID) run
