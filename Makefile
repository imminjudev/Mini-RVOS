...
BENCHMARK_BUILD = build-benchmark-q$(BENCHMARK_QUANTUM_TICKS)-s$(BENCHMARK_SWITCHES)
...
benchmark:
>$(MAKE) BUILD=$(BENCHMARK_BUILD) BENCHMARK_MODE=1 BENCHMARK_QUANTUM_TICKS=$(BENCHMARK_QUANTUM_TICKS) BENCHMARK_SWITCHES=$(BENCHMARK_SWITCHES) all

run-benchmark:
>$(MAKE) BUILD=$(BENCHMARK_BUILD) BENCHMARK_MODE=1 BENCHMARK_QUANTUM_TICKS=$(BENCHMARK_QUANTUM_TICKS) BENCHMARK_SWITCHES=$(BENCHMARK_SWITCHES) run
